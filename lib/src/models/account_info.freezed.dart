...
class _$AccountInfoImpl implements _AccountInfo {
  const _$AccountInfoImpl(
      {required this.name, this.email, this.channelHandle, this.thumbnailUrl});
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, name, email, channelHandle, thumbnailUrl);
...
abstract class _AccountInfo implements AccountInfo {
  const factory _AccountInfo(
      ...
      final String? email,
      final String? channelHandle,
      final String? thumbnailUrl}) = _$AccountInfoImpl;
