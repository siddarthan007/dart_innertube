...
mixin _$MusicResponsiveListItemRenderer {
  ...
  List<FlexColumn>? get fixedColumns => throw _privateConstructorUsedError;
    ...
    return _then(_value.copyWith(
      badges: freezed == badges
          ...
          : badges // ignore: cast_nullable_to_non_nullable
              as List<Badges>?,
      fixedColumns: freezed == fixedColumns
          ? _value.fixedColumns
          : fixedColumns // ignore: cast_nullable_to_non_nullable
              as List<FlexColumn>?,
...
class _$MusicResponsiveListItemRendererImpl
  ...
  @override
  List<FlexColumn>? get fixedColumns {
    ...
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            const DeepCollectionEquality()
                .equals(other._fixedColumns, _fixedColumns) &&
            const DeepCollectionEquality()
  ...
  int get hashCode => Object.hash(
      ...
      const DeepCollectionEquality().hash(_fixedColumns),
...
abstract class _MusicResponsiveListItemRenderer
    extends MusicResponsiveListItemRenderer {
  const factory _MusicResponsiveListItemRenderer(
          ...
          final NavigationEndpoint? navigationEndpoint}) =
      _$MusicResponsiveListItemRendererImpl;
  const _MusicResponsiveListItemRenderer._() : super._();
...
class _$MusicResponsiveListItemFlexColumnRendererImpl
  ...
  const _$MusicResponsiveListItemFlexColumnRendererImpl({this.text});
...
abstract class _MusicResponsiveListItemFlexColumnRenderer
  ...
  const factory _MusicResponsiveListItemFlexColumnRenderer({final Runs? text}) =
      _$MusicResponsiveListItemFlexColumnRendererImpl;
...
abstract class $PlaylistItemDataCopyWith<$Res> {
  ...
  @useResult
  $Res call({String? playlistSetVideoId, String videoId});
}
...
class _$PlaylistItemDataImpl implements _PlaylistItemData {
  const _$PlaylistItemDataImpl(
      {this.playlistSetVideoId, required this.videoId});
...
abstract class _PlaylistItemData implements PlaylistItemData {
  const factory _PlaylistItemData(
      {final String? playlistSetVideoId,
      required final String videoId}) = _$PlaylistItemDataImpl;
...
class _$OverlayCopyWithImpl<$Res, $Val extends Overlay>
  ...
  @override
  $Res call({
    Object? musicItemThumbnailOverlayRenderer = null,
  }) {
    return _then(_value.copyWith(
      musicItemThumbnailOverlayRenderer: null ==
...
class _$OverlayImpl implements _Overlay {
  const _$OverlayImpl({required this.musicItemThumbnailOverlayRenderer});
...
abstract class _Overlay implements Overlay {
  const factory _Overlay(
      {required final MusicItemThumbnailOverlayRenderer
...
mixin _$MusicItemThumbnailOverlayRenderer {
  OverlayContent get content => throw _privateConstructorUsedError;
...
abstract class $MusicItemThumbnailOverlayRendererCopyWith<$Res> {
  factory $MusicItemThumbnailOverlayRendererCopyWith(
      ...
      _$MusicItemThumbnailOverlayRendererCopyWithImpl<$Res,
          MusicItemThumbnailOverlayRenderer>;
  @useResult
  $Res call({OverlayContent content});

  $OverlayContentCopyWith<$Res> get content;
}
...
class _$MusicItemThumbnailOverlayRendererCopyWithImpl<$Res,
  ...
  @pragma('vm:prefer-inline')
  $OverlayContentCopyWith<$Res> get content {
    return $OverlayContentCopyWith<$Res>(_value.content, (value) {
...
class _$MusicItemThumbnailOverlayRendererImpl
  ...
  const _$MusicItemThumbnailOverlayRendererImpl({required this.content});
...
abstract class _MusicItemThumbnailOverlayRenderer
  ...
  const factory _MusicItemThumbnailOverlayRenderer(
          {required final OverlayContent content}) =
      _$MusicItemThumbnailOverlayRendererImpl;
...
OverlayContent _$OverlayContentFromJson(Map<String, dynamic> json) {
  return _OverlayContent.fromJson(json);
}
...
mixin _$OverlayContent {
  ...
  /// Serializes this OverlayContent to a JSON map.
  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;

  /// Create a copy of OverlayContent
  /// with the given fields replaced by the non-null parameter values.
  @JsonKey(includeFromJson: false, includeToJson: false)
  $OverlayContentCopyWith<OverlayContent> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $OverlayContentCopyWith<$Res> {
  factory $OverlayContentCopyWith(
          OverlayContent value, $Res Function(OverlayContent) then) =
      _$OverlayContentCopyWithImpl<$Res, OverlayContent>;
  @useResult
...
/// @nodoc
class _$OverlayContentCopyWithImpl<$Res, $Val extends OverlayContent>
    implements $OverlayContentCopyWith<$Res> {
  _$OverlayContentCopyWithImpl(this._value, this._then);
  ...
  @override
  $Res call({
    Object? musicPlayButtonRenderer = null,
  }) {
    return _then(_value.copyWith(
      musicPlayButtonRenderer: null == musicPlayButtonRenderer
...
/// @nodoc
abstract class _$$OverlayContentImplCopyWith<$Res>
    implements $OverlayContentCopyWith<$Res> {
  factory _$$OverlayContentImplCopyWith(_$OverlayContentImpl value,
          $Res Function(_$OverlayContentImpl) then) =
      __$$OverlayContentImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call({MusicPlayButtonRenderer musicPlayButtonRenderer});
...
/// @nodoc
class __$$OverlayContentImplCopyWithImpl<$Res>
    extends _$OverlayContentCopyWithImpl<$Res, _$OverlayContentImpl>
    implements _$$OverlayContentImplCopyWith<$Res> {
  __$$OverlayContentImplCopyWithImpl(
      _$OverlayContentImpl _value, $Res Function(_$OverlayContentImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$OverlayContentImpl(
      musicPlayButtonRenderer: null == musicPlayButtonRenderer
          ? _value.musicPlayButtonRenderer
          : musicPlayButtonRenderer // ignore: cast_nullable_to_non_nullable
              as MusicPlayButtonRenderer,
...
/// @nodoc
@JsonSerializable()
class _$OverlayContentImpl implements _OverlayContent {
  const _$OverlayContentImpl({required this.musicPlayButtonRenderer});

  factory _$OverlayContentImpl.fromJson(Map<String, dynamic> json) =>
      _$$OverlayContentImplFromJson(json);
  ...
  @override
  String toString() {
    return 'OverlayContent(musicPlayButtonRenderer: $musicPlayButtonRenderer)';
  }
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$OverlayContentImplCopyWith<_$OverlayContentImpl> get copyWith =>
      __$$OverlayContentImplCopyWithImpl<_$OverlayContentImpl>(
          this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$OverlayContentImplToJson(
      this,
    );
  }
}

abstract class _OverlayContent implements OverlayContent {
  const factory _OverlayContent(
          {required final MusicPlayButtonRenderer musicPlayButtonRenderer}) =
      _$OverlayContentImpl;

  factory _OverlayContent.fromJson(Map<String, dynamic> json) =
      _$OverlayContentImpl.fromJson;
